...
def _create_category(schema=0):
    ...
    if schema==0:
        ...
        categories = \
            [{"supercategory": "layout", "id": 0, "name": "Line"}]
...
parser.add_argument('--prima_datapath', type=str, default='/home/ubuntu/layout-model-training/data/prima', help='the path to the prima data folders')
parser.add_argument('--anno_savepath',  type=str, default='/home/ubuntu/layout-model-training/data/prima/annotations.json', help='the path to save the new annotations')

...
#                                                       256,
 ...
 #   newmodel = torch.nn.Sequential(*(list(mod.children())[:-1]))
    trainer.register_hooks(
            [hooks.EvalHook(0, lambda: trainer.eval_and_save(cfg, mod))]
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--eval_only",             default="True", help="evaluation purpose with pretrained net")
#    parser.add_argument("--resume",                default="True", help="start training from the pause")
    ...
    Process(target=startTensorboard, args=("/home/ubuntu/layout-model-training/outputs/prima/mask_rcnn_R_50_FPN_3x/",)).start()

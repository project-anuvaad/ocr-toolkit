...
class Page:
    ...
    def get_image(self,pdf_data,page_index):
        page_path = pdf_data['outputs'][0]['page_info'][page_index]
    ...
    def bbox2yolo(self, box, c_lass=0):
        ...
        thresh= abs(vertices[0]['y']-vertices[3]['y'])*0.20
        xmin = vertices[0]['x']
        xmax = vertices[1]['x']
        ymin = vertices[0]['y'] - thresh
        ymax = vertices[2]['y'] + thresh
...
if __name__ == '__main__':
    ...
    for gv_path in tqdm(gv_paths, desc="Files"):
        ...
        try:
            ...
            for page_index, page in enumerate(pages):
                ...
                if not os.path.exists(txt_path):
                    ...
                    image            = page_properties.get_image(pdf_data, page_index)

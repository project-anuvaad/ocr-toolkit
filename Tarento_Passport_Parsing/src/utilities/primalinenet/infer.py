...
model_primalinenet = lp.Detectron2LayoutModel(LINE_LAYOUT_CONFIG_PATH, model_path=LINE_LAYOUT_MODEL_PATH, label_map = {0:"type",1:"country",2:"pass",3:"sn",4:"name",5:"nt",6:"sex",7:"dob",8:"pob",9:"poi",10:"doi",11:"doe"}, extra_config=["MODEL.ROI_HEADS.SCORE_THRESH_TEST", LINE_PRIMA_SCORE_THRESH_TEST])

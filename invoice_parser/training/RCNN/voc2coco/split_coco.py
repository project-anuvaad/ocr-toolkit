...
def main(
    ...
    with open(annotation_path, "rt", encoding="UTF-8") as annotations:
        ...
        x, y = train_test_split(
            images, train_size=split_ratio, random_state=random_state
        )
...
annotation_path = "/home/dhiraj/ocr/Mestro/code/prima/data/train/annotations.json"
if __name__ == "__main__":

    parser.split_ratio = 0.75
